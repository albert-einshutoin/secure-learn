...
- macOS/Windows: Docker Desktop 4.42.0以上
- Linux: Docker EngineとDocker Compose 2.36.0以上
- 8GB以上のメモリ
- 20GB以上のディスク空き容量

この最低版は任意ではありません。IDSが監視する攻撃網を常に `eth0` に固定するため、Docker Compose 2.36.0で導入された [`interface_name`](https://docs.docker.com/reference/compose-file/services/#interface_name) を使用します。[Docker公式リリースノート](https://docs.docker.com/desktop/release-notes/#4420) 上、Docker Desktop 4.42.0はDocker Compose 2.36.2を同梱しています。`docker compose version` で2.36.0以上であることを確認してください。
