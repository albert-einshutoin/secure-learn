...
各フェーズのHTMLガイドは [Learning Phase Guides](../learning-phases/index.html) を正とします。HTMLには、抽象的に何を学ぶか、具体例、事前準備、安全境界、Hands-on Flow、Docker実行、観測ポイント、よくある失敗、セルフレビュー、合格証跡を入れています。
